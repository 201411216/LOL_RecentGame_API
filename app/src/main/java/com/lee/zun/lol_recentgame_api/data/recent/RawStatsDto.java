...
public class RawStatsDto {
    ...
    public int totalTimeCrowdControDealt;
    ...
    public int getCompatPlayerScore() {
        return compatPlayerScore;
    }
    ...
    public int getNumItemBought() {
        return numItemBought;
    }
    ...
    public int getTotalTimeCrowdControDealt() {
        return totalTimeCrowdControDealt;
    }
